# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2018-08-30 11:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bakhsh', models.CharField(blank=True, max_length=50, null=True)),
        ...
        migrations.AddField(
            model_name='need',
            name='unit',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='webgis.Unit'),
        ),
    ]
